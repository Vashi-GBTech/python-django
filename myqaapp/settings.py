"""
Django settings for myqaapp project.
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Absolute filesystem path to the directory where media files are stored

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-rl02$*w9%a9*9bf(a57!2vlf%4v9@zf4xg3ahisib&pl9xro$1'
...
WSGI_APPLICATION = 'myqaapp.wsgi.application'
